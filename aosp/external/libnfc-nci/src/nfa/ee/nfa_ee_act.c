...
tNFA_STATUS nfa_ee_route_add_one_ecb(tNFA_EE_ECB *p_cb, int max_len, BOOLEAN more, UINT8 *ps, int *p_cur_offset)
{
    ...
    NFA_TRACE_DEBUG2("nfa_ee_route_add_one_ecb : entry size before AID : %d ,  nfceeid: %d" , (UINT8)(pp - p), p_cb->nfcee_id);
    ...
    NFA_TRACE_DEBUG0("nfa_ee_route_add_one_ecb");
    ...
    if (tlv_size > max_tlv)
    {
        NFA_TRACE_DEBUG0 ("nfa_ee_route_add_one_ecb: exceeds routing table size - report ERROR");
