...
public:
    ...
    UINT32 mFowardFunctionalityEnable;
...
#define MAX_NFCEE 5
    ...
    **
    ** Description:     set the UICC Forward Functionality Enable/Disable.
    **
    **
    ** Returns:         Returns None.
    **
    *******************************************************************************/
    void setUiccForwardFunctionalityEnable(UINT32 functionalityEnabled);
#endif
