...
/*******************************************************************************
**
** Function:        setUiccForwardFunctionalityEnable
**
** Description:     setting the UICC Forward Functionality Enable/Disable.
**
**
** Returns:         Returns None.
**
*******************************************************************************/
void SecureElement::setUiccForwardFunctionalityEnable(UINT32 functionalityEnabled)
{
    mFowardFunctionalityEnable = functionalityEnabled;
}
